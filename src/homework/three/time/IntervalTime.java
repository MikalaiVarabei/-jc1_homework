...
public class IntervalTime {
    ...
    public IntervalTime(long secondsInterval) {
        ...
        this.hours = secondsInterval/3600;
        this.minutes = (secondsInterval - hours*3600)/60;
        this.seconds = secondsInterval - hours*3600 - minutes*60;
    }

    public IntervalTime(long seconds, long minutes, long hours) {
        this.secondsInterval = seconds + minutes*60 + hours*3600;
